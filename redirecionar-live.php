...
// Gera M3U8 inline apontando pro upstream via HTTPS
// Usa tags HLS completas para compatibilidade com ExoPlayer e players strict
$mediaUrl = preg_replace('#^http://joyfrvr\.cc:80/#', 'https://joyfrvr.cc/', $location);
$mediaUrl = preg_replace('#^http://38\.247\.134\.19:80/#', 'https://38.247.134.19/', $mediaUrl);
$channelName = htmlspecialchars_decode($resultado_streams["name"] ?? "Canal", ENT_QUOTES);
header("Content-Type: application/vnd.apple.mpegurl; charset=utf-8");
echo "#EXTM3U\r\n";
echo "#EXT-X-PLAYLIST-TYPE:VOD\r\n";
echo "#EXT-X-TARGETDURATION:10\r\n";
echo "#EXT-X-VERSION:3\r\n";
echo "#EXTINF:10.000,{$channelName}\r\n";
echo "{$mediaUrl}\r\n";
echo "#EXT-X-ENDLIST\r\n";
exit();
?>